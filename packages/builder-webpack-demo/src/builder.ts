...
import {deepCopy, listDir, merge, isEmpty, getCSSModulesLocalIdent} from './utils';
import Config from './config';

// 当前运行的时候的根目录
let projectRoot: string = Config.getPath('cli-demo.json');

if (!projectRoot) {
    projectRoot = Config.getPath('cli-demo.js');
}
...
class Builder {
    ...
    static setResolveLoaderPath(runtime?: string): object {
        ...
        const resolveLoaderPath = path.join(osenv.home(), './.cli-demo/node_modules');
        // Loader在捷豹平台的查找路径
