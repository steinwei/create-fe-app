...
// 当前运行的时候的根目录
var projectRoot = config_1.default.getPath('cli-demo.json');
if (!projectRoot) {
    projectRoot = config_1.default.getPath('cli-demo.js');
}
;
// 最基础的配置
var baseConfig = {
...
var Builder = /** @class */ (function () {
    ...
    Builder.createDevConfig = function (options) {
        var devConfig = utils_1.deepCopy(baseConfig);
        ...
        // 设置 loader 的npm包查找的相对路径，包括本地node_modules、.cli-demo、测试环境的node_module
    ...
    Builder.createProdConfig = function (options) {
        var prodConfig = utils_1.deepCopy(baseConfig);
        ...
        // 设置 loader 的npm包查找的相对路径，此处设置在全局的 .cli-demo 目录下
        ...
        return {
            ...
            use: [
                'style-loader',
                {
                    ...
                    options: {
                        modules: true,
                        getLocalIdent: utils_1.getCSSModulesLocalIdent
                    }
                }
            ]
        };
    ...
    Builder.setAlias = function (alias) {
        var aliasObject = {};
        utils_1.listDir(path_1.default.join(projectRoot, './src'), 1, []).forEach(function (dir) {
            var name = dir.name, dirPath = dir.dirPath;
            aliasObject['/' + name] = dirPath;
            aliasObject[name] = dirPath;
        });
        if (utils_1.isEmpty(alias)) {
            return aliasObject;
        }
        return utils_1.merge(alias, aliasObject);
    };
    Builder.setResolveLoaderPath = function (runtime) {
        var jbRuntime = runtime || 'runtime-now-6';
        var resolveLoaderPath = path_1.default.join(osenv_1.default.home(), './.cli-demo/node_modules');
        // Loader在捷豹平台的查找路径
