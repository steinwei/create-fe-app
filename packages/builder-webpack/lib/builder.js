...
// 当前运行的时候的根目录
var projectRoot = config_1.default.getPath('fe-cli.json');
if (!projectRoot) {
    projectRoot = config_1.default.getPath('fe-cli.js');
}
;
// 最基础的配置
var baseConfig = {
...
var Builder = /** @class */ (function () {
    ...
    Builder.setResolveLoaderPath = function (runtime) {
        ...
        var resolveLoaderPath = path_1.default.join(osenv_1.default.home(), './.fe-cli/node_modules');
        // Loader在捷豹平台的查找路径
